project(modelVersion: '4.0.0') {
	...
	properties {
		...
		/* JVM Management */
		'project.jdk.version' '1.8' // JDK 1.7 or above requiered by Jetty 9
		...
		'maven.minimal.version' '3.3.1'  // Maven 3.3.1 or above required by Maven Polyglot
		...
		/* used with antrun:run and jetty:run */ 
		...
		'jetty.version' '${jetty.maven.version}'
	...
	dependencies {
		...
		dependency('org.eclipse.jetty:jetty-annotations:${jetty.version}:provided')
		dependency('org.eclipse.jetty:jetty-rewrite:${jetty.version}:provided')
		
		/* JSP Compilation */
		dependency('org.eclipse.jetty:apache-jsp:${jetty.version}:provided')
		dependency('org.eclipse.jetty:apache-jstl:${jetty.version}:provided')
